...
import { POINTS_HUD_OFFSET_EVENT } from "../lib/streaming/pointsHud";
...
export function SettingsStreamingPlaybackPanel() {
  const { t } = useTranslation(["settings"]);
  const settings = useSettingsStore((s) => s.settings);
  const setSettings = useSettingsStore((s) => s.setSettings);
...
export function SettingsStreamingLayoutPanel() {
  const { t } = useTranslation(["settings"]);
  const settings = useSettingsStore((s) => s.settings);
  const setSettings = useSettingsStore((s) => s.setSettings);
        ...
        <label className="settings__row settings__row--check">
          <input
            ...
            onChange={async (e) => {
              ...
              const { syncEventSub } = await import("../lib/streaming/store");
              syncEventSub();
            }}
          />
          <span className="settings__check-text">
          ...
          <div className="settings__pair">
            ...
            <div className="settings__control">
              <input
                ...
                aria-label={t("settings:retryStreams")}
                onChange={(e) =>
                  setSettings({
                    streaming: {
                      ...settings.streaming,
          ...
          <div className="settings__pair">
            ...
            <div className="settings__control">
              <input
                ...
                aria-label={t("settings:retryMax")}
                onChange={(e) =>
                  setSettings({
                    streaming: {
                      ...settings.streaming,
...
export function SettingsPlayerPanel() {
  const { t } = useTranslation(["settings"]);
  const settings = useSettingsStore((s) => s.settings);
  const setSettings = useSettingsStore((s) => s.setSettings);
  return (
    <SettingsTabPanel>
        <div className="settings__row">
          ...
          <PlayerInstallHelp
            key={settings.player.id}
            guide={playerInstallGuide(settings.player.id)}
          >
            <select
              value={settings.player.id}
              aria-label={t("settings:playerId")}
              onChange={(e) =>
                setSettings({
                  player: {
                    ...settings.player,
        ...
        <div className="settings__row">
          ...
          <div className="settings__control">
            <input
              ...
              aria-label={t("settings:playerCustomArgs")}
              onChange={(e) =>
                setSettings({
        ...
        <div className="settings__row">
          ...
          <div className="settings__control">
            <select
              ...
              aria-label={t("settings:playerInput")}
              onChange={(e) =>
                setSettings({
                  player: {
                    ...settings.player,
        ...
        <div className="settings__row">
          ...
          <div className="settings__control">
            <select
              ...
              aria-label={t("settings:chatProvider")}
              onChange={(e) =>
                setSettings({
                  chat: {
                    ...settings.chat,
