"""Probe: branded loading screen in idle mpv, OSD on top, loadfile replaces."""
...
print_window(hwnd, "scripts/probe-loading-1-screen.png")
print("show-text:", ipc(["show-text", "Waiting for pre-roll ads…", "600000"]))
time.sleep(0.5)
print_window(hwnd, "scripts/probe-loading-2-osd.png")
print("loadfile:", ipc(["loadfile", "av://lavfi:testsrc=duration=60:size=640x360:rate=30"]))
print("clear osd:", ipc(["show-text", "", "1"]))
time.sleep(2.0)
print_window(hwnd, "scripts/probe-loading-3-video.png")
